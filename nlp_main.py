...
stops_other_hr_hold = ['senior', 'closely', 'federal', 'state', 'local', 'laws', 'preferred', 'qualification',
                       ...
                       'opportunityaffirmative', 'req', 'id', 'whats']
...
c19 = ['proof', 'vaccination', 'executive', 'order', 'requirement', 'order', '14042', 'required', 'full', 'mandate']
...
# execute nlp
n_gram_count = 2
n_gram_range_start, n_gram_range_stop  = 2800, 2900
