...
def clean_for_nlp(series_of_interest):
    ...
    additional_stopwords = sorted(list(set(['14042', '3rd', '401k', '50', '500', 'a16z', 'able', 'accepted',
                                            ...
                                            'limitless', 'nationality', 'consume', 'arent', 'variant', 'contacted', 'zoom', 'independence', 'protein', 'ryder', 'centralized', 'nike', 'unixlinux', 'demographic', 'deemed', 'bsba', 'longer', 'fulfilling', 'proudly', 'positioned', 'whatever', 'attack', 'encouraging', 'gained', 'providence', 'unmatched', 'pocs', 'entrylevel', 'spouse', 'adding', 'redefining', 'ohio', 'sole', 'mn', 'arcgis', 'dictionary', 'aipowered', 'modernize', 'tiktok', 'confidently', 'authenticity', 'asia', 'appreciate', 'fire', 'guidewire', 'police', 'databased', 'endless', 'conventional', 'improves', 'toptier', 'heshe', 'inquisitive', 'adp', 'backbone', 'stable', 'registry', 'koverse', 'noise', 'viable', 'lifechanging', 'resiliency', 'bottom', 'spoken', 'remediation', '57', 'iii', 'curve', 'publisher', 'democratize', 'portion', 'restaurant', 'julia', 'prohibit', 'velocity', 'diligence', 'yr', 'advises', 'venue', 'adapting', 'ssrs', 'bay', 'wireless', 'visually', 'caring', 'linking', 'credential', 'television', 'ease', 'robot', 'rooted', 'ia', 'awesome', 'observation', 'shareholder', 'usajobs', 'visitor', 'equipped', 'listener', 'intend', 'star', 'updated', 'chewy', 'alert', 'nonrelational', 'retrieve', 'semiconductor', 'correction', 'pythonr', 'licensed', 'anything', 'alexa', 'org', 'genuine', 'prevents', 'ar', 'quantity', 'minimize', 'invitation', 'mclean', 'depends', 'enhances', '400', 'hbase', 'hardest', 'compile', 'generalized', 'accomplished', 'ticket', 'downtown', 'transformer', 'utilized', 'depend', 'ibmibm', '3d', 'poc', 'challenged', 'writes', 'revolutionary', 'majority', 'allowance', 'ally', 'sustainment', 'parking', 'servicing', 'mac', 'thank', 'versatile', 'mantech', 'suggestion', 'presto', 'compliant', 'nltk', 'instrumental', 'multitasking', 'novartis', 'controlled', 'proofofconcept', 'enterprisewide', 'classifier', 'persona', 'humility', 'columbia', '80', 'ssa', 'securely', 'contractual', 'differential', 'multiyear']))) + ds_skills_combined
