...
# consider a function to identify and collapse key terms, like 'scientist' and 'science', 'analytics' and 'analysis', 'algorithm' and 'technique', 'oral' and'verbal', 'model' and 'modeling'
...
stops_permanent_hold = ['internal','external', 'new', 'capital', 'part']

stops_benefits_hold = ['paid', 'time']
