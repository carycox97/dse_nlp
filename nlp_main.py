...
def clean_for_nlp(series_of_interest):
    ...
    additional_stopwords = sorted(list(set(['14042', '3rd', '401k', '50', '500', 'a16z', 'able', 'accepted',
                                            ...
                                            'course', 'vendor', 'become', 'device', 'smart', 'ass', 'effectiveness', 'mean',
                                            ...
                                            'last', 'dream', 'requisition', 'invest', 'section', 'apple', 
                                            ...
                                            'biomedical', 'estimate', 'targeting', 'screen', 'maximum', 'cultural', 'promise',
                                            'initial', 'wayfair', 'living', 'ops', 'concern', 'cell', 'music', 'stipend', 'invite',
                                            'determined']))) + ds_skills_combined
