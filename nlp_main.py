...
#     'collaborate' and 'collaboratively' and 'work together' and 'work closely'
...
c19 = ['proof', 'vaccination', 'executive', 'order']
...
# execute nlp
n_gram_count = 2
n_gram_range_start, n_gram_range_stop  = 400, 500
