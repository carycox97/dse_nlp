...
def clean_for_nlp(series_of_interest):
    ...
    additional_stopwords = sorted(list(set(['14042', '3rd', '401k', '50', '500', 'a16z', 'able', 'accepted',
                                            ...
                                            'stereotype', 'telemetry', '800', 'biologist', 'nuclear', 'intensive',
                                            ...
                                            'naval', 'substance', 'sleeve', 'acceleration', 'specializes', 'georgia', 'pivotal', 'impala', 'ccpa', 'usd', 'safeguard', '510', 'rds', 'salt', 'elegant', '2017', 'stats', 'normalize', 'grammarly', 'educating', 'installation', 'ct', '17', 'strengthening', 'structuring', 'sw', 'everyones', 'crossdisciplinary', 'adaptability', 'permissible', 'moderna', 'duke', 'nontraditional', 'straightforward', 'functionally', 'visionary', 'expensive', 'learned', 'iconic', 'operationalizing', 'protective', 'introduce', 'expanded', '15000', 'faced', 'professor', 'filter', 'kmeans', 'ge', 'contracting', 'conceptualize', 'comprehension', 't', 'concurrently', 'rnn', 'planner', 'columbus', 'marketleading', 'october', 'defend', 'youtube', 'molecule', 'margin', 'kansa', '160000', 'stanley', 'mother', 'bug', 'medicaid']))) + ds_skills_combined
