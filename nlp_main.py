...
#     'model' and 'modeling', 'strong', 'excellent'
...
stops_permanent_hold = ['internal','external', 'new', 'capital', 'part', 'across', 'multiple', 'plus', 'clinical', 'trial',
...
stops_other_hr_hold = ['senior', 'closely', 'federal', 'state', 'local', 'laws', 'preferred', 'qualification',
                       ...
                       'diverse', 'inclusive', 'basic', 'paid', 'time', 'parental', 'leave', 'application', 'process',
                       'full', 'time', 'committed', 'providing', 'remote', 'required', 'basis', 'national',
                       'health', 'safety', 'place', 'competitive', 'salary', 'perform', 'essential', 'key', 'responsibility',
                       'creed', 'national']
...
# execute nlp
n_gram_count = 2
n_gram_range_start, n_gram_range_stop  = 200, 300
