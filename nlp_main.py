...
def clean_for_nlp(series_of_interest):
    ...
    additional_stopwords = sorted(list(set(['14042', '3rd', '401k', '50', '500', 'a16z', 'able', 'accepted',
                                            ...
                                            'ihub', 'acrobat', 'attrition', 'eventbrite', 'samara', 'sentar', 'infra']))) + ds_skills_combined
...
n_gram_count = 1
n_gram_range_start, n_gram_range_stop  = 600, 1200 # 3900, 4000 # NEXT - advance the range
