...
def clean_for_nlp(series_of_interest):
    ...
    additional_stopwords = sorted(list(set(['14042', '3rd', '401k', '50', '500', 'a16z', 'able', 'accepted',
                                            ...
                                            'worklife', 'workplace', 'world', 'would', 'york', 'youll', 'zone', 'view',
                                            ...
                                            'top', 'priority', 'internally', 'externally', 'performance', 'indicator', 'thrive',
                                            ...
                                            'country', 'option', 'revenue', 'execute', 'corporate']))) + ds_skills_combined
